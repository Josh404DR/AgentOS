...
target: https://example.com/packet
scope: 
files: 
constraints: create routing artifact only; source_not_verified until inspected; no submissions; no cleanup
output: data/codex_tasks/2026-06-25-url-intake-telegram-telegram-test-chat-url-packet-msg-packet-20260625-191730/OUTPUTS/RESULT.md
